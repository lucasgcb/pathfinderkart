...
void vParTestInitialise(void)
{
	...
	for (ul = 0; ul < partestNUM_LEDS; ul++) {
		...
		ioport_set_pin_dir(IN13, IOPORT_DIR_OUTPUT);
		...
		ioport_set_pin_level(ENB1,HIGH);
		ioport_set_pin_level(ENA1,HIGH);
...
{
	ioport_toggle_pin_level(IN14);
	ioport_toggle_pin_level(IN11);
	ioport_toggle_pin_level(IN12);
	ioport_toggle_pin_level(IN13);
}
